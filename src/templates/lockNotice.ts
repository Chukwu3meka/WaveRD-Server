export default ({ name }: any) => `
    ...
    <br />
    <br />
    Your account will be unlocked in 1 hour. If you believe this lock-out was in error, please contact our support team <a href="https://www.soccermass.com/info/contact-us">here</a>.
    <br />
    <br />
